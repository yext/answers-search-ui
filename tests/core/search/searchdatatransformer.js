...
describe('forming no results response', () => {
  ...
  it('does not alter original response ', () => {
    ...
    SearchDataTransformer._formResponseWithContext(response, ResultsContext.NO_RESULTS);

    expect(response).toEqual(initialResponse);
  });

  it('properly converts response with data', () => {
    const convertedResponse = SearchDataTransformer._formResponseWithContext(response, ResultsContext.NO_RESULTS);
  ...
  it('properly converts response with empty results', () => {
    ...
    const convertedResponse = SearchDataTransformer._formResponseWithContext(responseEmptyResults, ResultsContext.NO_RESULTS);
